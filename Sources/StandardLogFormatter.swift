...
open class StandardLogFormatter: FieldBasedLogFormatter
{
     ...
     */
    public init(timestampStyle: TimestampStyle? = .default, severityStyle: SeverityStyle? = .simple, delimiterStyle: DelimiterStyle? = nil, showCallSite: Bool = true, showCallingThread: Bool = false, colorizer: TextColorizer? = StandardLogTextColorizer(), colorTable: ColorTable? = nil)
    {
        var fields: [Field] = []
